...
export namespace DER {
  ...
  export function tryWriteToBytes<D extends DERWritable & Writable.Infer<D>>(triplet: DERTriplet<D>): Result<Bytes, Writable.SizeError<D> | Writable.WriteError<D> | BinaryWriteError> {
